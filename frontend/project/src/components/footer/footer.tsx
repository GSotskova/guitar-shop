          ...
          <div className="footer__container">
            ...
            <section className="footer__nav-section footer__nav-section--links">
              ...
              <ul className="footer__nav-list">
                <li className="footer__nav-list-item"><Link className="link footer__nav-link" to="#top">Где купить?</Link>
                </li>
                <li className="footer__nav-list-item"><Link className="link footer__nav-link" to="#top">Блог</Link>
                </li>
                <li className="footer__nav-list-item"><Link className="link footer__nav-link" to="#top">Вопрос - ответ</Link>
                </li>
                <li className="footer__nav-list-item"><Link className="link footer__nav-link" to="#top">Возврат</Link>
                </li>
                <li className="footer__nav-list-item"><Link className="link footer__nav-link" to="#top">Сервис-центры</Link>
                </li>
              </ul>
            </section>
